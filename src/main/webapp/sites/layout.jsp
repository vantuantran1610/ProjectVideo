	...
	<main class="container">
		...
		<nav class="row">
			<nav class="col navbar navbar-expand-sm navbar-light bg-light">
				<a class="navbar-brand" href="Homepage">Online</a>
				...
				<div class="collapse navbar-collapse" id="collapsibleNavId">
					<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="#"> <i
								class="fa fa-id-info" aria-hidden="true"></i>Aubout Us
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"> <i
		...
		<footer class="row">
			<div class="col text-center border-top">
				<strong>Van Tuan&copy;2022.All rights reserved</strong>
			</div>
		</footer>
	</main>
